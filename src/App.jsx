import { Environment, Html, Image, OrbitControls, useGLTF} from "@react-three/drei";
...
function App() {
    ...
    const fetchVideoData = async (id) => {
      try {
        const response = await axios.post(
          "http://localhost:8000/get-video-data",
          { id }
        );
  ...
  return (
    <>
      ...
      >
        <button onClick={playHandler} disabled={!readyToPlay && !ready} ref={recordButtonRef}>
          Start Recording
        </button>
      </div>
